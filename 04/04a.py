...
sleepiest_guard = max(schedule, key=lambda k: sum(schedule[k]))
sleepiest_hour = schedule[sleepiest_guard]
sleepiest_minute = sleepiest_hour.index(max(sleepiest_hour))
